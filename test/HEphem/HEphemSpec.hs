...
testHorizontal = TestList
                 [testHorizontalCoord s (mkUTCTime u) (mkHorzontal h) | (s, u, h) <- [ (mirfak, 0, ((93, 40, 15), (77, 39, 8)))
...
spec = describe "HEphem" $ do
        describe "siderealtime" $ do
          ...
          describe "solveAngle matches for  test values" $ do
              fromHUnitTest testSolveAngle

          describe "horizontal for a series of test values" $ do
